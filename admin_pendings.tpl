...
<table width="99%">
  ...
  <div class="comment">
    ...
    <p class="commentHeader"><strong><a href="{$photo.PIWIGO_URL}" target="_blank">{$photo.PIWIGO_GALLERY_TITLE}</a></strong> - <a class="icon-mail-alt" href="mailto:{$photo.CONTRIBUTOR_EMAIL}"></a> - <em>{$photo.ADDED_ON}</em></p>
    <table>
      <tr>
